...
export const TagIcon = () => {
  return (
    <svg
      ...
      height="24"
      fill="currentColor"
      className="bi bi-tags-fill mr-4"
...
export const BlogTags = ({ tags, children }) => {
  return (
    <p className="font-bold text-base text-tertiary mb-2">
      {children}
...
export const BlogTitleInfo = ({
  ...
  const update_comp = (
    <span>
      <span> • </span>
      <span>
        Last updated on <time dateTime={updated_datetime}>{updated}</time>
      </span>
    </span>
  )
